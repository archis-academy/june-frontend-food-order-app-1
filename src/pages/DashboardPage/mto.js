...
$(document).ready(function () {
  $("#progress-container").radialMultiProgress({
    ...
    antiAlias: false,
    scaleLabel: false,
    centerContent: "", // Center text is removed
    responsive: true,
    ...
    data: [
      {
        ...
        value: 65,
        range: [0, 100],
        color: "rgba(101, 176, 246, 1)", // En dıştaki halka
        animation: {
          duration: "1s",
          style: "ease"
        }
      },
      {
        ...
        value: 45,
        range: [0, 100],
        color: "rgba(255, 181, 114, 1)", // İkinci halka
        animation: {
          duration: "1s",
          style: "ease"
        }
      },
      {
        ...
        value: 55,
        range: [0, 100],
        color: "rgba(255, 124, 163, 1)", // Üçüncü halka
        animation: {
          duration: "1s",
          style: "ease"
        }
      ...
      {
        id: "progress7",
        value: 0, // En içteki halka boş
        range: [0, 100],
        color: "#333", // Değiştirmek istediğiniz renge göre ayarlayın
        animation: {
          duration: "1s",
          style: "ease"
        }
