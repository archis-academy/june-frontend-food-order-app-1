...
function Payment({ openPayment, setPaymentOpen }) {
  ...
  return (
    <div className={openPayment ? "payment-container" : "close-payment"}>
      ...
      <div className="payment-methods-container">
        ...
        <div className="methods-card-box">
          <div
            ...
            className={`methods-card ${selectedButton === "button1" ? "active" : ""
              }`}
          >
            <img src="./public/credit-card.svg" alt="" />
            <img
              className={`btn-check-icon ${selectedButton === "button1" ? "active" : ""
                }`}
          ...
          <div
            ...
            className={`methods-card ${selectedButton === "button3" ? "active" : ""
              }`}
          >
            <img src="./public/wallet.svg" alt="" />
            <img
              className={`btn-check-icon ${selectedButton === "button3" ? "active" : ""
                }`}
              src="./public/check-icon.svg"
              alt=""
            />
