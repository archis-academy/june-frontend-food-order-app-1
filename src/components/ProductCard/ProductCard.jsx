...
import ProductManagementEditDish from "../ProductManagementEditDish/ProductManagementEditDish";
...
function ProductCard({ image, description, price }) {
  ...
  return (
    <div className="product-card">
      ...
      <div className="edit-box" onClick={modalHandler}>
        <Modal
          isOpen={modalIsOpen}
          onRequestClose={modalHandler}
          style={customStyles}
        >
          <ProductManagementEditDish onButtonClick={modalHandler} />
        </Modal>
        <svg
